...
Three of the original four remain; **§4, the CPU wave evaluator, was built as M38** — see
`designs/notes/m38-buoyancy.md` and `designs/buoyancy-design.md`. It is kept below, struck through
...
## 4. A CPU wave evaluator, and therefore buoyancy — **BUILT (M38)**
...
4. ~~**The wave evaluator.**~~ Built as M38. The "wants a real consumer first" instinct was right
