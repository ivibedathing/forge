    ...
    pub fn builtin_palette() -> &'static [DaylightKeyframe] {
        ...
        static PALETTE: [DaylightKeyframe; 8] = [
            kf(
                0.0,
                [0.50, 0.60, 0.90], 0.0,
                [0.28, 0.34, 0.52], 0.045,
                [0.008, 0.013, 0.030], [0.020, 0.030, 0.055], [0.006, 0.007, 0.012],
                1.4,
            ),
            kf(
                4.5,
                [0.62, 0.58, 0.72], 0.0,
                [0.30, 0.34, 0.50], 0.070,
                [0.020, 0.035, 0.080], [0.075, 0.070, 0.105], [0.012, 0.013, 0.020],
                1.9,
            ),
            kf(
                6.0,
                [1.00, 0.34, 0.12], 0.16,
                [0.45, 0.42, 0.52], 0.155,
                [0.075, 0.130, 0.290], [0.640, 0.340, 0.230], [0.045, 0.040, 0.045],
                2.4,
            ),
            kf(
                6.7,
                [1.00, 0.62, 0.30], 0.72,
                [0.52, 0.52, 0.64], 0.185,
                [0.105, 0.190, 0.410], [0.660, 0.510, 0.430], [0.080, 0.075, 0.080],
                1.8,
            ),
            kf(
                12.0,
                [1.00, 0.98, 0.94], 1.35,
                [0.60, 0.68, 0.85], 0.220,
                [0.190, 0.340, 0.620], [0.620, 0.710, 0.820], [0.160, 0.160, 0.170],
                1.0,
            ),
            kf(
                17.3,
                [1.00, 0.62, 0.28], 0.72,
                [0.52, 0.50, 0.60], 0.180,
                [0.100, 0.180, 0.400], [0.680, 0.480, 0.380], [0.078, 0.070, 0.074],
                1.8,
            ),
            kf(
                18.0,
                [1.00, 0.32, 0.10], 0.16,
                [0.48, 0.40, 0.46], 0.150,
                [0.070, 0.120, 0.280], [0.720, 0.320, 0.190], [0.048, 0.040, 0.042],
                2.2,
            ),
            kf(
                19.5,
                [0.55, 0.42, 0.60], 0.0,
                [0.33, 0.36, 0.54], 0.075,
                [0.022, 0.038, 0.090], [0.090, 0.075, 0.115], [0.013, 0.014, 0.022],
                1.8,
            ),
        ];
